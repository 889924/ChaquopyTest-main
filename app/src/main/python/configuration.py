...
fileList = os.listdir(join(dirname(__file__),'test_data_tdsv'))
print(fileList)
person = len(fileList) + 1
...
data_arg.add_argument('--train_path', type=str, default='train_tdsv', help="train dataset directory")
data_arg.add_argument('--test_path', type=str, default='test_tdsv', help="test dataset directory")
...
data_arg.add_argument('--tdsv_frame', type=int, default=120, help="frame number of utterance of tdsv")
...
model_arg.add_argument('--model_path', type=str, default='tdsv_model', help="model directory to save or load")
...
train_arg.add_argument('--N', type=int, default=person, help="number of speakers of batch")
train_arg.add_argument('--M', type=int, default=4, help="number of utterances per speaker")
